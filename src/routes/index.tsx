  ...
  return (
    <div className="min-h-screen scroll-smooth">
      ...
      <main className="mx-auto max-w-5xl px-5 pb-24">
        ...
        {/* Pastoral */}
                {/* Ritmos de Oração */}
        <section id="oracao" className="scroll-mt-24 py-10">
          <SectionTitle>Ritmos de Oração</SectionTitle>
          <div className="rounded-2xl border border-gold/25 bg-card/70 p-7 sm:p-10 glow-gold">
            <p className="text-xs uppercase tracking-[0.35em] text-gold-soft">
              Oração Diária
            </p>
            ...
            <p className="mt-5 max-w-2xl leading-relaxed text-muted-foreground">
              Grave sua oração e a IA organizará os motivos de oração para você.
            </p>
            <div className="mt-7">
              <button
                className="inline-flex rounded-full bg-gold px-8 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.03]"
        ...
        {/* Evangelho */}
        <section id="evangelho" className="scroll-mt-24 py-10">
          <SectionTitle>Evangelho</SectionTitle>
          <div className="rounded-2xl border border-gold/25 bg-card/70 p-7 sm:p-10 glow-gold">
            <p className="text-xs uppercase tracking-[0.35em] text-gold-soft">
              Leitura Diária
            </p>
            ...
            <p className="mt-5 max-w-2xl leading-relaxed text-muted-foreground">
              Leia o Evangelho e clique no botão para ir para os 3 dias.
            </p>
            <div className="mt-7">
              <button
                className="inline-flex rounded-full bg-gold px-8 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.03]"
        ...
        {/* Ritmo Semanal */}
        <section id="ritmo-semanal" className="scroll-mt-24 py-10">
          <SectionTitle>Ritmo Semanal</SectionTitle>
          <div className="rounded-2xl border border-gold/25 bg-card/70 p-7 sm:p-10 glow-gold">
            <p className="text-xs uppercase tracking-[0.35em] text-gold-soft">
            ...
            <p className="mt-5 max-w-2xl leading-relaxed text-muted-foreground">
              Clique nas datas para ver os domingos.
            </p>
            <div className="mt-7">
              <button
                className="inline-flex rounded-full border border-gold/50 px-8 py-3 text-sm font-semibold text-gold transition-colors hover:bg-gold/10"
        ...
        <section id="descanso" className="scroll-mt-24 py-10">
          <SectionTitle>Descanso Intencional</SectionTitle>
          <div className="rounded-2xl border border-gold/25 bg-card/70 p-7 sm:p-10 glow-gold">
            <p className="text-xs uppercase tracking-[0.35em] text-gold-soft">
